        ...
        <div className="grid lg:grid-cols-2 gap-10 items-start">
          ...
          >
            {securityPoints.map((point, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="p-5 rounded-2xl bg-slate-800/30 border border-slate-700/50 hover:border-emerald-500/30 transition-colors"
                >
            ...
            <motion.div
              ...
              className="flex items-center gap-2 text-sm text-slate-500 pl-2"
            >
          ...
          >
            <div className="p-6 rounded-2xl bg-gradient-to-br from-slate-800/50 to-slate-800/30 border border-slate-700/50">
              <h3 className="text-lg font-semibold text-white mb-6">Как работает маскирование</h3>
              
              {/* Before */}
              <div className="mb-4">
                <div className="text-xs text-slate-500 uppercase tracking-wider mb-2">Сообщение клиента</div>
              ...
              {/* After */}
              <div className="mb-4">
                <div className="text-xs text-slate-500 uppercase tracking-wider mb-2">Отправляется в LLM</div>
