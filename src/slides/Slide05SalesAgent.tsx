...
const chatMessages = [
  ...
  { type: 'bot', text: 'Отлично! Рекомендую платье-миди из шифона в пудровом оттенке — 11 990 ₽. Лёгкое, не мнётся, идеально для жары. К нему есть босоножки в тон за 4 990 ₽. Показать образ целиком?' },
]
