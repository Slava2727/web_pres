...
import { ShoppingCart, Search, Gift, CreditCard, ArrowRight } from 'lucide-react'

const features = [
  {
    icon: Search,
    title: 'Работа с каталогом',
    description: 'Подбор товара по нечётким запросам: «платье на корпоратив» и т.п.',
  },
  {
    icon: Gift,
  ...
  },
  {
    icon: CreditCard,
    title: 'Финал сделки',
    description: 'Отправка карточки товара или ссылки на оплату с UTM-меткой',
  },
]

const chatMessages = [
  { type: 'user', text: 'Привет! Ищу платье на свадьбу подруги, бюджет до 15 000' },
  { type: 'bot', text: 'Здравствуйте! Подскажите ваш размер и предпочтительный цвет? Свадьба летняя или в помещении?' },
  { type: 'user', text: '44 размер, что-то нежное, свадьба в июле на природе' },
  { type: 'bot', text: 'Отлично! Рекомендую платье-миди из шифона в пудровом оттенке — 11 990 ₽. Лёгкое, не мнётся, идеально для жары. К нему есть босоножки в тон за 4 990 ₽. myshop.ru/product/13424?utm_source=naimi' },
]
